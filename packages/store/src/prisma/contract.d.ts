...
export type StorageHash =
  StorageHashBase<'2fa1a674eb0e8bffb31d54a4b6135338cafb77e6d1e15e7d9d71028694eb3b49'>;
export type ExecutionHash =
  ExecutionHashBase<'faca57d882e94e5f774bf7721dbd27c47a84fc30eb72eb7d1df92e3e47d31833'>;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly outbox: {
              ...
              indexes: readonly [
                {
                  readonly name: 'outbox_delivered_at_created_at_idx_e4092e18';
                  readonly prefix: 'outbox_delivered_at_created_at_idx';
                  readonly columns: readonly ['delivered_at', 'created_at'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [];
